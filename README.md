...
🚀 Building projects using Rust, React, Node.js & MongoDB

📚 Passionate about Systems Programming, Operating Systems & DSA

🎯 Open to Software Development, Backend & Rust Internship opportunities
...
<a href="mailto:tusharkumar1036@gmail.com">
...
A command-line file compressor written in Rust using the **flate2** crate.
...
A Rust CLI utility for efficient GZIP decompression.
...
My complete Rust learning journey following **The Rust Programming Language** book with notes, exercises and mini projects.
...
A Full Stack Air Quality Dashboard built using React, Node.js, SQLite and Leaflet.
